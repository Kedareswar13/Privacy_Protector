...
### Real-Time Privacy Search
Observe the AI scan the web, classify findings by risk level, and display actionable results.

![General Questions](assets/websearch_1.jpg)
![General Questions](assets/websearch_2.jpg)
